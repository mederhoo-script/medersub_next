    ...
    <html lang="en">
      ...
      <body className="antialiased font-sans">
        ...
        <a
          ...
          className="fixed bottom-18 right-0 bg-green-500 hover:bg-green-600 text-white p-3 rounded-full shadow-2xl hover:shadow-green-500/50 transition-all duration-300 hover:scale-110 z-[9999] flex items-center gap-2 animate-pulse hover:animate-none"
