        ...
        "DashboardPage.useEffect": ()=>{
            const fetchTransactions = {
                "DashboardPage.useEffect.fetchTransactions": async ()=>{
                    ...
                    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('transactions').select('*').eq('user_id', user.id).order('created_at', {
                        ascending: false
                    }).limit(5);
                    if (data && !error) {
...
_s(DashboardPage, "OUqN5271kYcV3hmS+ePt+Mvf4fY=");
_c = DashboardPage;
var _c;
...
//# sourceMappingURL=_3d193f1f._.js.map