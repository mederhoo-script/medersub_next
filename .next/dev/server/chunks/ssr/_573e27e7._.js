...
function DataPage() {
    ...
    // Filter plans when network changes or allDataPlans loads
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (allDataPlans.length > 0) {
            // Filter by network name. Inlomax keeps network in plan object usually.
            // Example plan: { serviceID: "35", network: "GLO", dataPlan: "500MB", amount: "205.00" }
...
//# sourceMappingURL=_573e27e7._.js.map