...
async function GET() {
    try {
        const { data: services, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2d$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('services').select('*').order('type', {
            ascending: true
        }).order('name', {
            ascending: true
        });
...
async function POST(req) {
    try {
        ...
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2d$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('services').update(updateData).eq('id', id);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a160fc8a._.js.map