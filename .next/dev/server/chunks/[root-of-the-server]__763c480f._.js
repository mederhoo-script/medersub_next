...
async function GET() {
    ...
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2d$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('system_settings').select('*');
...
async function POST(req) {
    try {
        ...
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2d$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('system_settings').upsert({
            key,
            value,
            updated_at: new Date()
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__763c480f._.js.map