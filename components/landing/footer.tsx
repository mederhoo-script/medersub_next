                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
                    ...
                    <div>
                        ...
                        <div className="space-y-4">
                            <a href="/download/medersub.apk" download className="bg-white/5 border border-green-500/40 rounded-xl p-4 flex items-center gap-4 hover:bg-white/10 transition-colors group relative">
                                ...
                                <span className="absolute -top-2 -right-2 bg-green-500 text-white text-[8px] font-bold px-2 py-0.5 rounded-full">DOWNLOAD</span>
                            </a>
